...
def test_api_batch_ingest(monkeypatch, client, ticker, start, end, expected_status):
...
def test_api_embed(monkeypatch, client):
    from app.datapipeline import apis as dp_apis
    ...
    resp = client.patch("/api/v0/pipeline/embed")
